...
class CustomDreamOnboardingPopup extends StatefulWidget {
  @override
  _CustomDreamOnboardingPopupState createState() => _CustomDreamOnboardingPopupState();
}

class _CustomDreamOnboardingPopupState extends State<CustomDreamOnboardingPopup> {
